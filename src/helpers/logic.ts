import { getNextTetrominoPosition, getNextTetrominos, getProjectedPlacePosition, getTetrominoPositionBounds, isInvalidTetrominoPosition, isTouchingPlacedTetriminosOrBottom } from ".";
import { ALL_TETROMINOS, HIDDEN_ROWS, INITIAl_TETROMINO_POSITIONS, ROTATION_MATRIX, SCORES, SRS_ROTATION_TESTS } from "../constants/tetris.constants";
import { Board, BoardRow, GameState, TetrisCallbackName, TetrisCallbacks, TetrominoPosition, TetrominoRotation, TetrominoRotationTestName } from "../types/tetris.types";
...
export const getInitialGameState = (): GameState => {
  ...
  return {
    ...
    activeTetromino: {
      ...
      projectedPlacePosition: getProjectedPlacePosition(
