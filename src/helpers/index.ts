import { ALL_TETROMINOS, HIDDEN_ROWS } from "../constants/tetris.constants";
import { Board, BoardPoint, Tetromino, TetrominoPosition } from "../types/tetris.types";
 ...
 */
export const getProjectedPlacePosition = (
  position: TetrominoPosition,
  placedTetrominos: Board
): TetrominoPosition => {
